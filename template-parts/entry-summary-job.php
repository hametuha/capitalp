<a class="job-list__link" href="<?php the_permalink(); ?>">
	...
	<section class="c-entry-summary">
		...
		<?php
		$terms = get_the_terms( get_post(), 'type' ); if ( $terms && ! is_wp_error( $terms ) ) :
...
endforeach;
		...
		<div class="c-entry-summary__body">
			...
			<ul class="job-list__keywords">
				<li>
					...
					<?php if ( capitalp_job_is_open() ) : ?>
						応募期限: <?php echo mysql2date( get_option( 'date_format' ), tscfp( '_job_expires' ) ); ?>
					<?php else : ?>
						募集終了
					<?php endif; ?>
				</li>
			...
			<div class="c-entry-summary__meta">
				<ul class="c-meta">
					<?php
					$companies = get_the_terms( get_post(), 'company' ); if ( $companies && ! is_wp_error( $companies ) ) :
