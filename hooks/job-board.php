 ...
 */
add_action(
	'manage_job_posts_custom_column',
...
add_action(
	...
	<tr>
		...
		<td>
			...
			<input id="company_url" name="company_url" type="url" class="regular-text" value="<?php echo esc_attr( get_term_meta( $term->term_id, '_url', true ) ); ?>" />
		</td>
	</tr>
		<?php
	},
