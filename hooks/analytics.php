	...
	function ( $atts, $content = '' ) {
		...
		<table>
			...
			<?php foreach ( $list as $row ) : ?>
				<tr>
					<th>
						<a href="<?php echo get_author_posts_url( $row['user']->ID, $row['user']->user_nicename ); ?>">
							<?php echo esc_html( $row['user']->display_name ); ?>
						</a>
					</th>
					<td><?php echo number_format_i18n( $row['pv'] ); ?></td>
				</tr>
			<?php endforeach; ?>
			</tbody>
		</table>
